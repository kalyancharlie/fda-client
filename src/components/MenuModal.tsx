...
const MenuModal: React.FC<MenuModalProps> = ({ visible, menu, onSave, onCancel, categories }) => {
  ...
  return (
    <Modal visible={visible} onCancel={onCancel} onOk={handleSubmit} title={menu ? 'Edit Menu' : 'Add Menu'}>
